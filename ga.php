...
Uncomment /dev/random if you need a **really random** key and don't mind blocking while the page 
loads if the system runs out of "random"
...
<html lang="en-US">
<head>
<title>QR Code Generator for One-Time Passwords with Google Authenticator and mod_authn_otp</title>
</head>
<body>
<h2>QR Code Generator for One-Time Passwords with Google Authenticator and mod_authn_otp</h2>
<table>
<TR><TD>Add this line to the mod_authn_opt users file on your server</TD></TR>
...
<tr><td>
<iframe style="border:none;" height="252" width="252" src="qr.php?url=otpauth://totp/<?php echo $site ?>%3Fsecret%3D<?php echo $secret ?>"></iframe>
</td></tr>
...
Many portions written/copyright by others as noted in the source code at https://www.cnysupport.com/ga.txt
...
/**
 * PHPGangsta_GoogleAuthenticator modified by Terry Carmen (terry@cnysupport.com) to output the secret in Base16 as required by mod_authn_opt.
 *
